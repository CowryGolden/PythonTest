...
# print('md5.hexdigest() =', md5.hexdigest())    # md5.hexdigest() = d26a53750bc40b38b65a520292f69306
...
r'''
    #注：MD5是最常见的摘要算法，速度很快，生成结果是固定的128 bit字节，通常用一个32位的16进制字符串表示。
