...
# -*- coding: utf-8 -*-
r'''
    # 常用內建模块：urllib的request模块Get请求使用
    # 使用场景：
...
r'''
    #注：可以看到HTTP响应的头和JSON数据：
            Status: 200 OK
            Date : Fri, 20 Apr 2018 02:41:10 GMT
